...
- Чеклист `back/TODO.md` синхронизирован с текущим Nest-кодом (MVP API); открытые пункты — CORS без proxy (не используется), учебный блок §2.0, опциональный dev-лог §2.9.
- Следующий продуктовый шаг **этапа 15**: мини-спека в `back/TODO.md` §5.1 (**DTO + class-validator**), далее — SQLite/Prisma или auth по выбору.
