...
- [x] ✅ Два распространённых варианта (выбрать один и отметить в коммите/README):
  ...
  - [ ] **Вариант B:** состояние рядом с фичей, например `features/projects/data/project.store.ts` — ближе к модульности (опциональный рефакторинг, не блокер MVP) — _на момент синхронизации планов с репозиторием не делаем: оставляем Вариант A._
